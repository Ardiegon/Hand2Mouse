...
def parse_arguments():
    ...
    parser.add_argument("--click-threshold", type=float, default=10, help="Threshold of mouse clicks")
    parser.add_argument("--cursor-sensitivity", type=float, default=3, help="Factor of how movement of hand transforms into mouse movement")
    parser.add_argument("--filter-length", type=int, default=7, help="How many frames of clicking with fingers shoudl sensor read before signal")
